...
static retro_core_option_v2_definition s_opts[] = {
    ...
    { "mednafen_stv_input_layout", "Input Layout", NULL,
      ...
      { {"gamepad","Gamepad (ergonomic)"},{"jamma","JAMMA (arcade wiring)"},{NULL,NULL} }, "gamepad" },
...
static retro_core_option_definition s_opts_v1[] = {
    ...
    { "mednafen_stv_input_layout",     "Input Layout",
      NULL, { {"gamepad","Gamepad (ergonomic)"},{"jamma","JAMMA (arcade wiring)"},{NULL,NULL} }, "gamepad" },
...
RETRO_API void retro_set_environment(retro_environment_t cb)
{
    ...
    if (version >= 2)
        ...
        static const retro_variable legacy[] = {
            ...
            {"mednafen_stv_input_layout",      "Input Layout; gamepad|jamma"},
